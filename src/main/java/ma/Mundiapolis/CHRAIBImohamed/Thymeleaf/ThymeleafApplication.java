package ma.Mundiapolis.CHRAIBImohamed.Thymeleaf; // Je mets ma classe principale dans ce package

import ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.entities.Product; // J'utilise mon entité Product
import ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.repository.ProductRepository; // J'accède à la base via le repository
