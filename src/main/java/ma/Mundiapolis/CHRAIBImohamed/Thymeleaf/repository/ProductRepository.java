package ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.repository; // Dossier où se trouve le repository

import ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.entities.Product; // J'utilise l'entité Product
