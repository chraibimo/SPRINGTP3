package ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.web; // Je place ici mes contrôleurs web
...
import ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.entities.Product; // Mon entité Product
import ma.Mundiapolis.CHRAIBImohamed.Thymeleaf.repository.ProductRepository; // J'accède à la base via ce repository
